          ...
          <div className="flex flex-row items-center justify-between gap-3 md:gap-0">
            <div className="flex md:hidden flex-row items-center gap-2">
              <Link href="https://www.instagram.com/hourrail/">
                <FaInstagram className="text-3xl text-hourrail-orange"/>
              </Link>
              <Link href="https://www.linkedin.com/company/hourrail/">
                <FaLinkedin className="text-3xl text-hourrail-orange" href="https://www.linkedin.com/company/hourrail/"/>
              </Link>
            </div>
            <Logo large />
            <UserMenu currentUser={currentUser} />
          </div>
          <span className="text-white text-3xl sm:text-4xl font-bold text-center">
